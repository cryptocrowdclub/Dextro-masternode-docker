...
docker build -t "dextromasternode39323" .
...
echo "port=39323" >>/root/dextro.conf
echo "rpcport=8143" >>/root/dextro.conf
echo "rpcallowip=127.0.0.1" >>/root/dextro.conf
echo "addnode=140.82.12.172:39323" >>/root/dextro.conf
echo "addnode=45.77.7.58:39323" >>/root/dextro.conf
echo "addnode=96.126.101.142:39323" >>/root/dextro.conf
echo "addnode=80.211.5.23:39323" >>/root/dextro.conf
echo "addnode=104.236.13.159:39323" >>/root/dextro.conf
echo "addnode=104.236.13.159:39323" >>/root/dextro.conf
echo "addnode=104.236.13.159:39323" >>/root/dextro.conf
...
docker run -d --name dextromasternode39323 dextromasternode39323
docker cp /root/dextro.conf dextromasternode39323:/root/.dextro/
docker cp /root/dextro/dextrod dextromasternode39323:/root/dextro/
docker commit dextromasternode39323 dextromasternode39323
docker container rm dextromasternode39323
echo 'loading master node...'
docker run -d --restart always -p 39323:39323 --name dextromasternode39323 dextromasternode39323 /root/dextro/dextrod -datadir=/root/.dextro -conf=/root/.dextro/dextro.conf
docker start dextromasternode39323
