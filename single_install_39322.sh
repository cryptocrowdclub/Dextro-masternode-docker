...
docker build -t "dextromasternode39322" .
...
echo "port=39322" >>/root/dextro.conf
echo "rpcport=8142" >>/root/dextro.conf
echo "rpcallowip=127.0.0.1" >>/root/dextro.conf
echo "addnode=140.82.12.172:39322" >>/root/dextro.conf
echo "addnode=45.77.7.58:39322" >>/root/dextro.conf
echo "addnode=96.126.101.142:39322" >>/root/dextro.conf
echo "addnode=80.211.5.23:39322" >>/root/dextro.conf
echo "addnode=104.236.13.159:39322" >>/root/dextro.conf
echo "addnode=104.236.13.159:39322" >>/root/dextro.conf
echo "addnode=104.236.13.159:39322" >>/root/dextro.conf
...
echo "masternodeaddr=$IP:39322" >>/root/dextro.conf
#docker stop dextromasternode
docker run -d --name dextromasternode39322 dextromasternode39322
docker cp /root/dextro.conf dextromasternode39322:/root/.dextro/
docker cp /root/dextro/dextrod dextromasternode39322:/root/dextro/
docker commit dextromasternode39322 dextromasternode39322
docker container rm dextromasternode39322
echo 'loading master node...'
docker run -d --restart always -p 39322:39322 --name dextromasternode39322 dextromasternode39322 /root/dextro/dextrod -datadir=/root/.dextro -conf=/root/.dextro/dextro.conf
docker start dextromasternode39322
