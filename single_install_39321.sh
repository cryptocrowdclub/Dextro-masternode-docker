...
docker build -t "dextromasternode39321" .
...
echo "rpcport=8141" >>/root/dextro.conf
...
echo "addnode=96.126.101.142:39321" >>/root/dextro.conf
echo "addnode=80.211.5.23:39321" >>/root/dextro.conf
echo "addnode=104.236.13.159:39321" >>/root/dextro.conf
echo "addnode=104.236.13.159:39321" >>/root/dextro.conf
echo "addnode=104.236.13.159:39321" >>/root/dextro.conf
...
echo "masternodeaddr=$IP:39321" >>/root/dextro.conf
#docker stop dextromasternode
docker run -d --name dextromasternode39321 dextromasternode39321
docker cp /root/dextro.conf dextromasternode39321:/root/.dextro/
docker cp /root/dextro/dextrod dextromasternode39321:/root/dextro/
docker commit dextromasternode39321 dextromasternode39321
docker container rm dextromasternode39321
echo 'loading master node...'
docker run -d --restart always -p 39321:39321 --name dextromasternode39321 dextromasternode39321 /root/dextro/dextrod -datadir=/root/.dextro -conf=/root/.dextro/dextro.conf
docker start dextromasternode39321
